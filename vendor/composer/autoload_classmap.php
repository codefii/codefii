...
return array(
    ...
    'App\\Controllers\\Sys\\AddPosts' => $baseDir . '/App/Controllers/Sys/AddPosts.php',
    ...
    'Codefii\\Cli\\FiiCli' => $vendorDir . '/codefii/framework/src/Network/Cli/FiiCli.php',
    'Codefii\\Contracts\\Routing\\RouterInterface' => $vendorDir . '/codefii/framework/src/Network/Contracts/Routing/RouterInterface.php',
    'Codefii\\Controller\\BaseController' => $vendorDir . '/codefii/framework/src/Network/Controller/BaseController.php',
    'Codefii\\Entity\\Auth\\FiiAuth' => $vendorDir . '/codefii/framework/src/Network/Entity/auth/FiiAuth.php',
    'Codefii\\Entity\\Orm\\Database' => $vendorDir . '/codefii/framework/src/Network/Entity/orm/Database.php',
    'Codefii\\Entity\\Orm\\Fiirm' => $vendorDir . '/codefii/framework/src/Network/Entity/orm/Fiirm.php',
    'Codefii\\Hash\\Hash' => $vendorDir . '/codefii/framework/src/Network/Hash/Hash.php',
    'Codefii\\Http\\Input' => $vendorDir . '/codefii/framework/src/Network/Http/Input.php',
    'Codefii\\Http\\Redirect' => $vendorDir . '/codefii/framework/src/Network/Http/Redirect.php',
    'Codefii\\Http\\Request' => $vendorDir . '/codefii/framework/src/Network/Http/Request.php',
    'Codefii\\Http\\Response' => $vendorDir . '/codefii/framework/src/Network/Http/Response.php',
    'Codefii\\Mapper\\ModelValidator\\ModelValidator' => $vendorDir . '/codefii/framework/src/Network/Mapper/ModelValidator/ModelValidator.php',
    'Codefii\\Mapper\\Process\\LeaveOffice' => $vendorDir . '/codefii/framework/src/Network/Mapper/Process/LeaveOffice.php',
    'Codefii\\Mapper\\Process\\Logger' => $vendorDir . '/codefii/framework/src/Network/Mapper/Process/Logger.php',
    'Codefii\\Mapper\\Process\\Model\\Admin' => $vendorDir . '/codefii/framework/src/Network/Mapper/Process/Model/Admin.php',
    'Codefii\\Mapper\\Process\\Office' => $vendorDir . '/codefii/framework/src/Network/Mapper/Process/Office.php',
    'Codefii\\Mapper\\Process\\Runner' => $vendorDir . '/codefii/framework/src/Network/Mapper/Process/Runner.php',
    'Codefii\\Routing\\Router' => $vendorDir . '/codefii/framework/src/Network/Routing/Router.php',
    'Codefii\\Session\\Session' => $vendorDir . '/codefii/framework/src/Network/Session/Session.php',
    'Codefii\\Support\\Porter' => $vendorDir . '/codefii/framework/src/Network/Support/Porter.php',
    'Codefii\\Validation\\Validation' => $vendorDir . '/codefii/framework/src/Network/Validation/Validation.php',
    'Codefii\\View\\View' => $vendorDir . '/codefii/framework/src/Network/View/View.php',
